	...
	<div class="zl_1200">
		...
		<h3>涌玉会员登录</h3>
			<form action="userLoginlist.do" method="POST" onsubmit="return login()">
				...
				<div class="box"><span>用户名</span><div><input type="text" class="txt" id="username" name="username"></div></div>
				<div class="box"><span>密&nbsp;&nbsp;&nbsp;码</span><div><input type="password" name="password" id="password" class="txt"></div></div>
				<div class="box2"><label class="fuxuan"><input type="checkbox" name="fx"><span>记住用户名</span></label><div class="password"><a href="#">忘记密码？</a></div></div>
