...
public class UserController {
	...
	public String registerUser(com.ftc.ad.vo.User user,Model model,HttpServletRequest request){
		if (logger.isDebugEnabled()) {
	...
	public String registerUserInfo(com.ftc.ad.vo.User user,Model model,HttpServletRequest request){
		if (logger.isDebugEnabled()) {
